<template>
  <div class="app-container">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body v-dialogDrag v-dialogDragHeight>
    ...
    <!-- 任务日志详细 -->
    <el-dialog title="任务详细" :visible.sync="openView" width="700px" append-to-body v-dialogDrag v-dialogDragHeight>
