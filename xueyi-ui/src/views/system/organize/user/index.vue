        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="归属岗位" prop="postIds">
              <treeselect v-model="form.postIds" :options="organizeOptions" :multiple="true" :disableBranchNodes="true"
                          :normalizer="normalizer" placeholder="请选择归属岗位"
              />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
import { listUserApi, getUserApi, addUserApi, editUserApi, delUserApi } from '@/api/system/organize/user'
...
import UserRoleModal from '@/views/system/organize/user/UserRoleModal'
      ...
      this.$refs['form'].validate(valid => {
        if (valid) {
          if (this.form.id !== undefined) {
            editUserApi(this.form).then(response => {
