...
const name = process.env.VUE_APP_TITLE || '初始化模板' // 网页标题

const port = process.env.port || process.env.npm_config_port || 79 // 端口
...
module.exports = {
  ...
  // 例如 https://xueyitt.cn/。如果应用被部署在一个子路径上，你就需要用这个选项指定这个子路径。例如，如果你的应用被部署在 https://xueyitt.cn/admin/，则设置 baseUrl 为 /admin/。
  publicPath: process.env.NODE_ENV === "production" ? "/" : "/",
  // publicPath: process.env.NODE_ENV === "production" ? "/initialized/" : "/initialized/",
