  ...
  <div class="app-container">
    ...
    <div class="wrapper-container">
      ...
      <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="字典编码" align="center" prop="dictCode" min-width="120"/>
        <el-table-column label="字典标签" align="center" prop="dictLabel" min-width="120">
        ...
        <el-table-column label="字典键值" align="center" prop="dictValue" min-width="120"/>
    ...
    <!-- 添加或修改参数配置对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body v-dialogDrag v-dialogDragHeight>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除字典编码为"' + dictCodes + '"的数据项?', "警告").then(function () {
