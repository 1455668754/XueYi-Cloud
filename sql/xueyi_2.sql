...
-- 系统Id 2 租户Id -1(超管)
       ...
       (20000, 2, -1, 0, '租户管理', 'tenant',      null, 'M', '0', '', 'xy_tenant',     6, 0, '租户管理目录'),
              ...
              -- 二级菜单
              (20020, 2, -1, 20000, '数据源', 'source',   'tenant/source/index',      'C', '0',  'tenant:source:list',      '#',   1, 0, '数据源菜单'),
                                   -- 数据源管理按钮
                                   (20021, 2, -1, 20020, '数据源查询', '', '', 'F', '0', 'tenant:source:query',           '#', 1, 0, ''),
                                   (20022, 2, -1, 20020, '数据源新增', '', '', 'F', '0', 'tenant:source:add',             '#', 2, 0, ''),
