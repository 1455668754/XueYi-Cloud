...
-- 系统Id 2 租户Id -1(超管)
       ...
       (20000, 2, -1, 0, '租户管理', 'tenant',      null, 'M', '0', '', 'xy_tenant',     6, 0, '租户管理目录'),
              -- 二级菜单
              (20010, 2, -1, 20000, '租户管理', 'tenant',    'system/tenant/tenant/index',  'C', '0', 'system:tenant:list',    'xy_tenant',    1, 0, '租户管理菜单'),
                                   -- 租户管理按钮
                                   (20011, 0, -1, 20010, '租户查询', '#', '', 'F', '0', 'system:tenant:query',          '#', 1, 0, ''),
                                   (20012, 0, -1, 20010, '租户新增', '#', '', 'F', '0', 'system:tenant:add',            '#', 2, 0, ''),
                                   (20013, 0, -1, 20010, '租户修改', '#', '', 'F', '0', 'system:tenant:edit',           '#', 3, 0, ''),
                                   (20014, 0, -1, 20010, '租户删除', '#', '', 'F', '0', 'system:tenant:remove',         '#', 4, 0, ''),
              -- 二级菜单
              ...
              (20050, 2, -1, 20000, '数据源策略', 'strategy',   'tenant/strategy/index',      'C', '0',  'tenant:strategy:list',      '#',   1, 0, '数据源策略菜单'),
                                   -- 数据源策略按钮
                                   (20051, 0, 0, 20050, '数据源策略查询', '', '', 'F', '0', 'tenant:strategy:query',           '#', 1, 0, ''),
                                   (20052, 0, 0, 20050, '数据源策略新增', '', '', 'F', '0', 'tenant:strategy:add',             '#', 2, 0, ''),
                                   (20053, 0, 0, 20050, '数据源策略修改', '', '', 'F', '0', 'tenant:strategy:edit',            '#', 3, 0, ''),
                                   (20054, 0, 0, 20050, '数据源策略删除', '', '', 'F', '0', 'tenant:strategy:remove',          '#', 4, 0, ''),
       -- 一级菜单
