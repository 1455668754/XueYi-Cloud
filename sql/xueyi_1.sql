...
-- 初始化-菜单信息表数据
-- ----------------------------
insert into sys_menu (menu_id, system_id, tenant_id, parent_id, menu_name, path, component, is_frame, is_cache, menu_type, visible, perms, icon, sort, create_by, remark)
values
-- 系统Id 0 租户Id 0(公用)
       -- 一级菜单
