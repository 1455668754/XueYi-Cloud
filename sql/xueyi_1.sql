...
-- 系统Id 2 租户Id -1(超管)
       ...
       (20000, 2, -1, 0, '租户管理', 'tenant',      null, '', 1, 1, 'M', '0', '', 'xy_tenant',     6, 0, '租户管理目录'),
              ...
              (20010, 2, -1, 20000, '租户管理', 'tenant',    'tenant/tenant/index',  '', 1, 1, 'C', '0', 'tenant:tenant:list',    'xy_tenant',    1, 0, '租户管理菜单'),
                     ...
                     -- 二级菜单
              (20050, 2, -1, 20000, '策略管理', 'strategy',   'tenant/strategy/index',     '', 1, 1, 'C', '0',  'tenant:strategy:list',      'xy_strategy',   1, 0, '数据源策略菜单'),
                                   -- 数据源策略按钮
                                   (20051, 2, -1, 20050, '策略查询', '', '', '', 1, 1, 'F', '0', 'tenant:strategy:query',           '#', 1, 0, ''),
                                   (20052, 2, -1, 20050, '策略新增', '', '', '', 1, 1, 'F', '0', 'tenant:strategy:add',             '#', 2, 0, ''),
                                   (20053, 2, -1, 20050, '策略修改', '', '', '', 1, 1, 'F', '0', 'tenant:strategy:edit',            '#', 3, 0, ''),
                                   (20054, 2, -1, 20050, '策略删除', '', '', '', 1, 1, 'F', '0', 'tenant:strategy:remove',          '#', 4, 0, ''),
                                   (20055, 2, -1, 20050, '策略导出', '', '', '', 1, 1, 'F', '0', 'tenant:strategy:export',          '#', 5, 0, ''),
              -- 二级菜单
