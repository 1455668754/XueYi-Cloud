...
-- 系统Id 0 租户Id 0(公用)
       -- 一级菜单
       (10100, 0, 0, 0, '组织管理', 'organize',   null, '', 'Y', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_organization', 1, 0, '组织管理目录'),
              -- 二级菜单
              (10110, 0, 0, 10100, '部门管理', 'dept',   'system/organize/dept/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y',  'system:dept:list',      'xy_dept',   1, 0, '部门管理菜单'),
                                   -- 部门管理按钮
                                   (10111, 0, 0, 10110, '部门查询', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:dept:query',           '#', 1, 0, ''),
                                   (10112, 0, 0, 10110, '部门新增', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:dept:add',             '#', 2, 0, ''),
                                   (10113, 0, 0, 10110, '部门修改', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:dept:edit',            '#', 3, 0, ''),
                                   (10114, 0, 0, 10110, '部门删除', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:dept:remove',          '#', 4, 0, ''),
              -- 二级菜单
              (10120, 0, 0, 10100, '岗位管理', 'post',   'system/organize/post/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y',  'system:post:list',      'xy_post',   2, 0, '岗位管理菜单'),
                                   -- 岗位管理按钮
                                   (10121, 0, 0, 10120, '岗位查询', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:post:query',           '#', 1, 0, ''),
                                   (10122, 0, 0, 10120, '岗位新增', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:post:add',             '#', 2, 0, ''),
                                   (10123, 0, 0, 10120, '岗位修改', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:post:edit',            '#', 3, 0, ''),
                                   (10124, 0, 0, 10120, '岗位删除', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:post:remove',          '#', 4, 0, ''),
                                   (10125, 0, 0, 10120, '岗位导出', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:post:export',          '#', 5, 0, ''),
              -- 二级菜单
              (10130, 0, 0, 10100, '用户管理', 'user',   'system/organize/user/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y',  'system:user:list',      'xy_user',   3, 0, '用户管理菜单'),
                                   -- 用户管理按钮
                                   (10131, 0, 0, 10130, '用户查询', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:query',           '#', 1, 0, ''),
                                   (10132, 0, 0, 10130, '用户新增', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:add',             '#', 2, 0, ''),
                                   (10133, 0, 0, 10130, '用户修改', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:edit',            '#', 3, 0, ''),
                                   (10134, 0, 0, 10130, '用户删除', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:remove',          '#', 4, 0, ''),
                                   (10135, 0, 0, 10130, '用户导出', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:export',          '#', 5, 0, ''),
                                   (10136, 0, 0, 10130, '用户导入', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:import',          '#', 6, 0, ''),
                                   (10137, 0, 0, 10130, '重置密码', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:user:resetPwd',        '#', 7, 0, ''),
       -- 一级菜单
       (10200, 0, 0, 0, '企业账户', 'enterprise', null, '', 'Y', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_enterprise',   2, 0, '企业账户目录'),
              (10210, 0, 0, 10200, '资料管理', 'dict',   'system/dataSetting/enterprise/profile/index',        '', 'Y', 'Y', 'N', 'N', 'C', 'Y',  'system:enterprise:list',      'xy_dict',   1, 0, '资料管理菜单'),
                                   -- 字典管理按钮
                                   (10211, 0, 0, 10210, '资料查看权限', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:enterprise:list',      '#', 1, 0, ''),
                                   (10212, 0, 0, 10210, '普通操作权限', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:enterprise:edit',      '#', 2, 0, ''),
                                   (10213, 0, 0, 10210, '超管操作权限', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:enterpriseAdmin:edit', '#', 3, 0, ''),
       -- 一级菜单
       (10300, 0, 0, 0, '系统管理', 'system',     null, '', 'Y', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_setting',      3, 0, '系统管理目录'),
              -- 二级菜单
              (10310, 0, 0, 10300, '通知公告', 'notice', 'system/system/notice/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y',  'system:notice:list',    'xy_message', 3, 0, '通知公告菜单'),
                                   -- 通知公告按钮
                                   (10311, 0, 0, 10310, '公告查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:notice:query',        '#', 1, 0, ''),
                                   (10312, 0, 0, 10310, '公告新增', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:notice:add',          '#', 2, 0, ''),
                                   (10313, 0, 0, 10310, '公告修改', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:notice:edit',         '#', 3, 0, ''),
                                   (10314, 0, 0, 10310, '公告删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:notice:remove',       '#', 4, 0, ''),
              -- 二级菜单
              (10320, 0, 0, 10300, '日志管理', 'log',    '',                                '', 'Y', 'Y', 'N', 'N', 'M', 'Y',  '',                      'xy_log',    4, 0, '日志管理菜单'),
                     -- 三级菜单
                     (10321, 0, 0, 10320, '操作日志', 'operlog',   'system/system/journal/operlog/index',    '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'system:operlog:list',   'xy_log_operation',  1, 0, '操作日志菜单'),
                                   -- 操作日志按钮
                                   (10322, 0, 0, 10321, '操作查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:operlog:query',       '#', 1, 0, ''),
                                   (10323, 0, 0, 10321, '操作删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:operlog:remove',      '#', 2, 0, ''),
                                   (10324, 0, 0, 10321, '日志导出', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:operlog:export',      '#', 3, 0, ''),
                     -- 三级菜单
                     (10325, 0, 0, 10320, '登录日志', 'loginInfo', 'system/system/journal/loginInfo/index',  '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'system:loginInfo:list', 'xy_log_loginInfo',  2, 0, '登录日志菜单'),
                                   -- 登录日志按钮
                                   (10326, 0, 0, 10325, '登录查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:loginInfo:query',     '#', 1, 0, ''),
                                   (10327, 0, 0, 10325, '登录删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:loginInfo:remove',    '#', 2, 0, ''),
                                   (10328, 0, 0, 10325, '日志导出', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:loginInfo:export',    '#', 3, 0, ''),
       -- 一级菜单
       (10400, 0, 0, 0, '权限管理', 'authority',  null, '', 'Y', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_authority',    3, 0, '权限管理目录'),
              -- 二级菜单
              (10410, 0, 0, 10400, '角色管理', 'role',   'system/authority/role/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'system:role:list',      'xy_role',    1, 0, '角色管理菜单'),
                                   -- 角色管理按钮
                                   (10411, 0, 0, 10410, '角色查询', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:query',           '#', 1, 0, ''),
                                   (10412, 0, 0, 10410, '角色授权', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:set',             '#', 2, 0, ''),
                                   (10413, 0, 0, 10410, '角色新增', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:add',             '#', 3, 0, ''),
                                   (10414, 0, 0, 10410, '角色修改', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:edit',            '#', 4, 0, ''),
                                   (10415, 0, 0, 10410, '角色删除', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:remove',          '#', 5, 0, ''),
                                   (10416, 0, 0, 10410, '角色导出', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:role:export',          '#', 6, 0, ''),
              -- 二级菜单
              (10420, 0, 0, 10400, '菜单管理', 'menu',   'system/authority/menu/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'system:menu:list',      'xy_menu',    2, 0, '菜单管理菜单'),
                                   -- 菜单管理按钮
                                   (10421, 0, 0, 10420, '菜单查询', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:menu:query',           '#', 1, 0, ''),
                                   (10422, 0, 0, 10420, '菜单新增', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:menu:add',             '#', 2, 0, ''),
                                   (10423, 0, 0, 10420, '菜单修改', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:menu:edit',            '#', 3, 0, ''),
                                   (10424, 0, 0, 10420, '菜单删除', '', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:menu:remove',          '#', 4, 0, ''),
              -- 二级菜单
              (10430, 0, 0, 10400, '模块管理', 'system', 'system/authority/system/index',   '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'system:system:list',    'xy_system',  3, 0, '模块管理菜单'),
                                   -- 模块管理按钮
                                   (10431, 0, 0, 10430, '模块管理查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:system:query',    '#', 1, 0, ''),
                                   (10432, 0, 0, 10430, '模块管理新增', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:system:add',      '#', 2, 0, ''),
                                   (10433, 0, 0, 10430, '模块管理修改', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:system:edit',     '#', 3, 0, ''),
                                   (10434, 0, 0, 10430, '模块管理删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:system:remove',   '#', 4, 0, ''),
       -- 一级菜单
       (10500, 0, 0, 0, '系统监控', 'monitor',    null, '', 'Y', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_monitor',         4, 0, '系统监控目录'),
              -- 二级菜单
              (10510, 0, 0, 10500, '在线用户', 'online', 'system/monitor/online/index',     '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'monitor:online:list',   'xy_online',  1, 0, '在线用户菜单'),
                                   -- 在线用户按钮
                                   (10511, 0, 0, 10510, '在线查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:online:query',       '#', 1, 0, ''),
                                   (10512, 0, 0, 10510, '批量强退', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:online:batchLogout', '#', 2, 0, ''),
                                   (10513, 0, 0, 10510, '单条强退', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:online:forceLogout', '#', 3, 0, ''),

              -- 二级菜单
              (10520, 0, 0, 10500, '定时任务', 'job',    'system/monitor/job/index',        '', 'Y', 'Y', 'N', 'N', 'C', 'Y', 'monitor:job:list',      'xy_job',     2, 0, '定时任务菜单'),
                                   -- 定时任务按钮
                                   (10521, 0, 0, 10520, '任务查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:query',          '#', 1, 0, ''),
                                   (10522, 0, 0, 10520, '任务新增', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:add',            '#', 2, 0, ''),
                                   (10523, 0, 0, 10520, '任务修改', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:edit',           '#', 3, 0, ''),
                                   (10524, 0, 0, 10520, '任务删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:remove',         '#', 4, 0, ''),
                                   (10525, 0, 0, 10520, '状态修改', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:changeStatus',   '#', 5, 0, ''),
                                   (10526, 0, 0, 10520, '任务导出', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'monitor:job:export',         '#', 6, 0, ''),
       -- 一级菜单
       (10600, 0, 0, 0, '素材管理', null,       null, '', 'Y', 'Y', 'N', 'N', 'M', '1', '', 'xy_tool',     9, 0, '素材管理目录'),
                                   -- 素材模块按钮
                                   (10601, 0, 0, 10600, '素材查询', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:material:query',        '#', 1, 0, ''),
                                   (10602, 0, 0, 10600, '素材新增', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:material:add',          '#', 2, 0, ''),
                                   (10603, 0, 0, 10600, '素材编辑', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:material:edit',         '#', 3, 0, ''),
                                   (10604, 0, 0, 10600, '素材删除', '#', '', '', 'Y', 'Y', 'N', 'N', 'F', 'Y', 'system:material:remove',       '#', 4, 0, ''),

-- 系统Id 2 租户Id -1(超管)
       -- 一级菜单
       (20000, 2, -1, 0, '租户管理', 'tenant',      null, '', 'N', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_tenant',     6, 0, '租户管理目录'),
              -- 二级菜单
              (20010, 2, -1, 20000, '租户管理', 'tenant',    'tenant/tenant/index',  '', 'N', 'Y', 'N', 'N', 'C', 'Y', 'tenant:tenant:list',    'xy_tenant',    1, 0, '租户管理菜单'),
                                   -- 租户管理按钮
                                   (20011, 0, -1, 20010, '租户查询', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:tenant:query',          '#', 1, 0, ''),
                                   (20012, 0, -1, 20010, '租户新增', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:tenant:add',            '#', 2, 0, ''),
                                   (20013, 0, -1, 20010, '租户修改', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:tenant:edit',           '#', 3, 0, ''),
                                   (20014, 0, -1, 20010, '菜单配置', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:tenant:role',           '#', 4, 0, ''),
                                   (20015, 0, -1, 20010, '租户删除', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:tenant:remove',         '#', 5, 0, ''),
                     -- 二级菜单
              (20050, 2, -1, 20000, '策略管理', 'strategy',   'tenant/strategy/index',     '', 'N', 'Y', 'N', 'N', 'C', 'Y',  'tenant:strategy:list',      'xy_strategy',   1, 0, '数据源策略菜单'),
                                   -- 数据源策略按钮
                                   (20051, 2, -1, 20050, '策略查询', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:strategy:query',           '#', 1, 0, ''),
                                   (20052, 2, -1, 20050, '策略新增', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:strategy:add',             '#', 2, 0, ''),
                                   (20053, 2, -1, 20050, '策略修改', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:strategy:edit',            '#', 3, 0, ''),
                                   (20054, 2, -1, 20050, '策略删除', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:strategy:remove',          '#', 4, 0, ''),
                                   (20055, 2, -1, 20050, '策略导出', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:strategy:export',          '#', 5, 0, ''),
              -- 二级菜单
              (20020, 2, -1, 20000, '数据源管理', 'source',   'tenant/source/index',     '', 'N', 'Y', 'N', 'N', 'C', 'Y',  'tenant:source:list',      'xy_source',   1, 0, '数据源菜单'),
                                   -- 数据源管理按钮
                                   (20021, 2, -1, 20020, '数据源查询', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:source:query',           '#', 1, 0, ''),
                                   (20022, 2, -1, 20020, '数据源新增', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:source:add',             '#', 2, 0, ''),
                                   (20023, 2, -1, 20020, '数据源修改', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:source:edit',            '#', 3, 0, ''),
                                   (20024, 2, -1, 20020, '数据源配置', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:separation:edit',        '#', 4, 0, ''),
                                   (20025, 2, -1, 20020, '数据源删除', '', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tenant:source:remove',          '#', 5, 0, ''),
       -- 一级菜单
       (20100, 2, -1, 0, '系统管理', 'system',     null, '', 'N', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_setting',      3, 0, '系统管理目录'),
              (20110, 2, -1, 20100, '字典管理', 'dict',   'system/system/dict/index',        '', 'N', 'Y', 'N', 'N', 'C', 'Y',  'system:dict:list',      'xy_dict',   1, 0, '字典管理菜单'),
                                   -- 字典管理按钮
                                   (20111, 2, -1, 20110, '字典查询', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:dict:query',          '#', 1, 0, ''),
                                   (20112, 2, -1, 20110, '字典新增', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:dict:add',            '#', 2, 0, ''),
                                   (20113, 2, -1, 20110, '字典修改', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:dict:edit',           '#', 3, 0, ''),
                                   (20114, 2, -1, 20110, '字典删除', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:dict:remove',         '#', 4, 0, ''),
                                   (20115, 2, -1, 20110, '字典导出', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:dict:export',         '#', 5, 0, ''),
              -- 二级菜单
              (20120, 2, -1, 20100, '参数管理', 'config', 'system/system/config/index',     '', 'N', 'Y', 'N', 'N', 'C', 'Y',  'system:config:list',    'xy_config', 2, 0, '参数管理菜单'),
                                   -- 参数设置按钮
                                   (20121, 2, -1, 20120, '参数查询', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:config:query',        '#', 1, 0, ''),
                                   (20122, 2, -1, 20120, '参数新增', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:config:add',          '#', 2, 0, ''),
                                   (20123, 2, -1, 20120, '参数修改', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:config:edit',         '#', 3, 0, ''),
                                   (20124, 2, -1, 20120, '参数删除', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:config:remove',       '#', 4, 0, ''),
                                   (20125, 2, -1, 20120, '参数导出', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'system:config:export',       '#', 5, 0, ''),
       -- 一级菜单
       (20200, 2, -1, 0, '系统监控', 'monitor',    null, '', 'N', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_monitor',         4, 0, '系统监控目录'),
              -- 二级菜单
              (20210, 2, -1, 20200, 'Sentinel控制台', 'http://localhost:8718',      '',     '', 'N', 'Y', 'Y', 'N', 'C', 'Y', 'monitor:sentinel:list', 'xy_sentinel', 1, 0, '流量控制菜单'),
              -- 二级菜单
              (20220, 2, -1, 20200, 'Nacos控制台',    'http://localhost:8848/nacos', '',     '', 'N', 'Y', 'Y', 'N', 'C', 'Y', 'monitor:nacos:list',    'xy_nacos',    2, 0, '服务治理菜单'),
              -- 二级菜单
              (20230, 2, -1, 20200, 'Admin控制台',    'http://localhost:9100/login', '',     '', 'N', 'Y', 'Y', 'N', 'C', 'Y', 'monitor:server:list',   'xy_server',   3, 0, '服务监控菜单'),
              -- 二级菜单
              (20240, 2, -1, 20200, 'rabbit控制台',   'http://localhost:15672/#/', '',       '', 'N', 'Y', 'Y', 'N', 'C', 'Y', 'monitor:rabbitmq:list',  'xy_rabbit',  4, 0, '消息队列菜单'),
       -- 一级菜单
       (20300, 2, -1, 0, '系统工具', 'tool',       null, '', 'N', 'Y', 'N', 'N', 'M', 'Y', '', 'xy_tool',     5, 0, '系统工具目录'),
              -- 二级菜单
              (20310, 2, -1, 20300, '表单构建', 'build',  'tool/build/index',                '', 'N', 'Y', 'N', 'N', 'C', 'Y', 'tool:build:list',       'xy_build',   1, 0, '表单构建菜单'),
              -- 二级菜单
              (20320, 2, -1, 20300, '代码生成', 'gen',    'tool/gen/index',                  '', 'N', 'Y', 'N', 'N', 'C', 'Y', 'tool:gen:list',         'xy_code',    2, 0, '代码生成菜单'),
                                   -- 代码生成按钮
                                   (20321, 2, -1, 20320, '生成查询', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:query',             '#', 1, 0, ''),
                                   (20322, 2, -1, 20320, '生成修改', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:edit',              '#', 2, 0, ''),
                                   (20323, 2, -1, 20320, '生成删除', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:remove',            '#', 3, 0, ''),
                                   (20324, 2, -1, 20320, '导入代码', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:import',            '#', 4, 0, ''),
                                   (20325, 2, -1, 20320, '预览代码', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:preview',           '#', 5, 0, ''),
                                   (20326, 2, -1, 20320, '生成代码', '#', '', '', 'N', 'Y', 'N', 'N', 'F', 'Y', 'tool:gen:code',              '#', 6, 0, ''),
              -- 二级菜单
              (20330, 2, -1, 20300, '系统接口', 'http://localhost:8080/swagger-ui/index.html', '', '', 'N', 'Y', 'Y', 'N', 'C', 'Y', 'tool:swagger:list',     'xy_swagger', 3, 0, '系统接口菜单');
...
values (1, 1, '男', '0', 'sys_user_sex', '', '', 'Y', 0, '性别男'),
       ...
       (44, 1, '私有', 'N', 'sys_common_type', '', '', 'N', 1, '私有');
