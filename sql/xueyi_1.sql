...
create table xy_tenant_database (
  ...
  attribution_database      tinyint	            not null default 0	                    comment '归属数据库(0系统默认 1独立库)',
...
create table xy_tenant (
  ...
  tenant_full_name		    varchar(50)	        not null 	                            comment '租户全称',
  ...
  tenant_database_status    tinyint             default 0                               comment '租户表数据状态(0无 1有)',
  sort                      tinyint             not null default 0                      comment '显示顺序',
  status                    char(1)             not null default '0'                    comment '状态（0正常 1停用）',
  create_by                 bigint              default null                            comment '创建者',
  create_time               datetime            default current_timestamp               comment '创建时间',
...
-- 初始化-租户信息表数据
-- ----------------------------
insert into xy_tenant (tenant_name, tenant_full_name, tenant_nick, tenant_logo)
values ('xueYi', '雪忆', 'xueYi1', 'http://127.0.0.1:9300/statics/2021/04/02/73c90edd-8d51-4fb9-b61e-06a0b4630d5b.jpg'),
       ('xueYi2', '雪忆', 'xueYi2', 'http://127.0.0.1:9300/statics/2021/04/02/73c90edd-8d51-4fb9-b61e-06a0b4630d5b.jpg');
...
values (1 , '商城' ,  '[{"materialId": "1384755423424516096", "materialUrl": "http://127.0.0.1:9300/statics/2021/04/21/5ec82664-b6cd-48b6-92e5-478d16b61428.jpg", "materialNick": "5ec82664-b6cd-48b6-92e5-478d16b61428.jpg", "hiddenVisible": false, "materialOriginalUrl": "http://127.0.0.1:9300/statics/2021/04/21/d90c13a0-11b5-4314-ad20-f05c6ff18497.jpg"}]' , '1' , '轻松打造在线商城', 1),
