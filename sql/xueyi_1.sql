...
-- 系统Id 2 租户Id -1(超管)
       ...
       (20000, 2, -1, 0, '租户管理', 'tenant',      null, '', 1, 1, 'M', '0', '', 'xy_tenant',     6, 0, '租户管理目录'),
              ...
              -- 二级菜单
              (20020, 2, -1, 20000, '数据源配置', 'source',   'tenant/source/index',     '', 1, 1, 'C', '0',  'tenant:source:list',      'xy_source',   1, 0, '数据源菜单'),
                                   -- 数据源管理按钮
                                   (20021, 2, -1, 20020, '数据源配置查询', '', '', '', 1, 1, 'F', '0', 'tenant:source:query',           '#', 1, 0, ''),
                                   (20022, 2, -1, 20020, '数据源配置新增', '', '', '', 1, 1, 'F', '0', 'tenant:source:add',             '#', 2, 0, ''),
                                   (20023, 2, -1, 20020, '数据源配置修改', '', '', '', 1, 1, 'F', '0', 'tenant:source:edit',            '#', 3, 0, ''),
                                   (20024, 2, -1, 20020, '数据源配置删除', '', '', '', 1, 1, 'F', '0', 'tenant:source:remove',          '#', 4, 0, ''),
                                   (20025, 2, -1, 20020, '数据源配置导出', '', '', '', 1, 1, 'F', '0', 'tenant:source:export',          '#', 5, 0, ''),
              -- 二级菜单
              (20030, 2, -1, 20000, '主从配置', 'separation',   'tenant/separation/index',     '', 1, 1, 'C', '0',  'tenant:separation:list',      'xy_master-slave',   1, 0, '主从配置菜单'),
                                   -- 读写分离按钮 SQL
                                   (20031, 2, -1, 20030, '主从配置查询', '', '', '', 1, 1, 'F', '0', 'tenant:separation:query',           '#', 1, 0, ''),
                                   (20032, 2, -1, 20030, '主从配置配置', '', '', '', 1, 1, 'F', '0', 'tenant:separation:edit',            '#', 2, 0, ''),
       -- 一级菜单
