...
public class VelocityUtils {
    ...
    /** 默认上级菜单，系统管理 */
    private static final String DEFAULT_PARENT_MENU_ID = "10300";

    /** 默认归属模块，默认系统 */
    private static final String DEFAULT_PARENT_SYSTEM_ID = "0";
    ...
    public static void setMenuVelocityContext(VelocityContext context, GenTable genTable) {
        ...
        String parentSystemId = getParentSystemId(paramsObj);
        context.put("parentMenuId", parentMenuId);
        context.put("parentSystemId", parentSystemId);
     ...
     * @return 归属模块Id字段
     */
    public static String getParentSystemId(JSONObject paramsObj) {
        if (StringUtils.isNotEmpty(paramsObj) && paramsObj.containsKey(GenConstants.PARENT_SYSTEM_ID)) {
            return paramsObj.getString(GenConstants.PARENT_SYSTEM_ID);
        }
        return DEFAULT_PARENT_SYSTEM_ID;
    }
